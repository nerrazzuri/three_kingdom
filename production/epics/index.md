...
- ✅ **出征攻城循环**（epic-029，Complete；2026-07-04 扩六维准备维度 + HUD 入口，见 GDD_019 v2/ADR-0011，已 push）。
- 🟢 **战斗核心层·区域战斗**（epic-031，**Ready for Stories**）：2026-07-04 用户裁定"排兵布阵=重点、战斗=与其他三国演义差异点须最完善"——战场区域部署 + 战中动态调整 + 敌方AI区域博弈 + 攻守统一，替换竖切脚本战斗。锚点齐：GDD_021 Draft + ADR-0012/0013 Accepted + TR-zone-001~010。**首次落地 GDD_016 敌AI**（吸收 epic-021 意图）。
- ✅ **人才招揽循环**（epic-030，**Complete** 2026-07-04）：出现随历史（时间窗）/ 知晓靠情报（反全知）/ 入伙靠条件+种子化判定（无胜率）/ 喂给为将。GDD_020 Implemented · TR-talent-001~004 · 940/940 绿。
- ✅ **M12 多城战区**（epic-025，**Complete** 2026-07-04）：占城→直辖多城→委任下属打理（不越权）+ 掌管范围随官阶 + 资源守恒 + 反全知报告。GDD_022 · TR-theater-001~004 · 949/949 绿。
- ✅ **M11 外交战略约束**（epic-024，**Complete** 2026-07-04）：外交立场约束战争（盟/邻攻须背约）+ 缔约（条件+种子·盟约更难）+ 背约代价。GDD_023 · TR-diplomacy-101~104 · 955/955 绿。
- ✅ **M13 君主争霸**（epic-026，**Complete** 2026-07-04）：群雄争霸态 + 对手种子化兼并（强吞弱）+ 支配度。GDD_017 · TR-contention-001/002 · 963/963 绿。原硬阻塞已解。
- ✅ **M14 统一终局**（epic-027，**Complete** 2026-07-04）：统一/覆灭终局判定（支配度阈/群雄尽灭/领城归零）。GDD_018 · TR-endgame-001 · 963/963 绿。原硬阻塞已解。
