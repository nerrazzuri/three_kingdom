...
| [城市治理循环](epic-016-city-governance-loop/EPIC.md) | Feature（M03） | 城市治理接入会话→喂给战争/生涯 | ADR-0009/0008/0003/0004 + TR-city-001~005 | 4 stories | 🔨 In Progress |
...
- 16 epics（3 Foundation + 6 Core + 1 Presentation + 2 Feature Meta + 3 Assembly + 1 Feature M03）；15 ✅ Complete + epic-016 🔨 Ready。
- 56 stories ✅ Complete（含 epic-015 太守开局循环 4）；本地回归 **622/622 全绿，`-warnaserror` 0 warning**。
...
★ **M00/M01/M02 装配完成（2026-06-29）**，**M03 城市治理循环 epic 已建**（epic-016，🔨 Ready）。

**当前动作**：M03 已拆为 4 story（S001 城市态接入会话 / S002 治理命令入口 / S003 治理改变战役条件 / S004 治理存读档确定性）。`/story-readiness epic-016 story-001` → 逐 story `/dev-story`。注意 M03 含**新生产代码**（区别于 M01/M02 纯测试），护栏：单城 MVP + 喂给战争的筛选尺子；征募已移出 MVP（待扩 GDD_004）。
