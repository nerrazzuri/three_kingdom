...
见 `tests/unit/ThreeKingdom.Domain.Tests/World/CampaignHistoryDivergenceTests.cs`（详见 Completion Notes）。
...
**Required evidence**:
- `tests/unit/ThreeKingdom.Domain.Tests/World/CampaignHistoryDivergenceTests.cs` — 必须存在且全绿
...
**Test Evidence**: `tests/unit/ThreeKingdom.Domain.Tests/World/CampaignHistoryDivergenceTests.cs` — 4 tests, 全绿（797/797）
