# Story 001: 历史世界态接入会话（目录 + 触及 + 分叉配置）
...
见 `tests/unit/ThreeKingdom.Domain.Tests/World/CampaignHistoryStateTests.cs`（详见 Completion Notes）。
...
**Required evidence**:
- `tests/unit/ThreeKingdom.Domain.Tests/World/CampaignHistoryStateTests.cs` — 必须存在且全绿
...
**Test Evidence**: `tests/unit/ThreeKingdom.Domain.Tests/World/CampaignHistoryStateTests.cs` — 3 tests, 全绿（797/797）
