...
> **已完成并 push**：11-1 `cf00edb` · 12-1 `6414b32` · 11-2 `51039f6` · 11-3 `dfed215` · 12-2 `1003b4e`（★全 Must 毕）· **11-4 太守开局守城**（补 ADR-0008 `ICityControlAuthority` 最小实现+CitySeed+守城胜败→生涯/归属经 004 事件；520/520 绿，同时解锁 12-4）。**Should 余 2：12-3 分叉传播 → 11-5 生涯存档(Integration)。**
